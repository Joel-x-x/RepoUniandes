<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo" style="height: 120px;">
        <span class="app-brand-logo demo">
            <img src="../public/images/logo.png" style="width: 30%;">
        </span>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="autores/autores.view.php" target="base" class="menu-link">
            <i class="menu-icon tf-icons bx bx-book-reader"></i>
                <?php $_SESSION['rutas'] = 'Autores'; ?>
                <div data-i18n="Without navbar">Autores</div>
            </a>
        </li>
        <li class="menu-item">
        <a href="blogs/blogs.view.php" target="base" class="menu-link">
