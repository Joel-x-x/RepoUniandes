                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand" style="text-align: center;">
                            <span class="app-brand-logo demo d-flex flex-row justify-content-center">
                        ...
                        <form action="controllers/usuarios.controllers.php?op=login" class="mb-3" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" placeholder="Ingrese su correo elctrónico" autofocus />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    " class="form-control" name="clave" placeholder="*************" aria-describedby="password" />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                            </div>

                            <div class="mb-3">
                                <button class="btn btn-dark d-grid w-100" type="submit">Ingresar</button>
                            </div>
                        </form>
