    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form id="form_usuarios" method="post">
                ...
                <div id="contenedor-canvas" style="display: flex; justify-content: center;">
                    <video width="300" height="300" autoplay style="border-radius: 50%; border: 5px solid #005A9F;"></video>
                </div>
